...
public enum Month {
     ...
     * @throws RuntimeException if the month value is out of range
     * @param month the number to check if in range
     */
    protected static void checkRange(int month) {
        if (month <= 0 || month > 12) {
            throw new RuntimeException("Value " + month + " is out of range [1<=month<=12]");
        }
    }
     ...
     * </p>
     *
     * @throws RuntimeException if either month value is not valid
    ...
    public int getDaysFromEndOfYear(boolean isLeapYear) {
        ...
        switch (this) {
            ...
            case NOVEMBER:  days = (61);                         break;
            case OCTOBER:   days = (92);                         break;
            case SEPTEMBER: days = (122);                        break;
            case AUGUST:    days = (153);                        break;
            case JULY:      days = (184);                        break;
            case JUNE:      days = (214);                        break;
            case MAY:       days = (245);                        break;
            case APRIL:     days = (275);                        break;
            case MARCH:     days = (306);                        break;
            case FEBRUARY:  days = (334 + (isLeapYear ? 1 : 0)); break;
            case JANUARY:
            default:
    ...
    /**
     * Gives the number of days to the start of a month from the end of the year.
     * @throws RuntimeException if the month value given is invalid
    ...
    public int getDaysFromStartOfYear(boolean isLeapYear) {
        ...
        switch (this) {
            case JANUARY:   days = 0;                          break;
            case FEBRUARY:  days = 31;                         break;
            case MARCH:     days = 59 + (isLeapYear ? 1 : 0);  break;
            case APRIL:     days = 90 + (isLeapYear ? 1 : 0);  break;
            case MAY:       days = 120 + (isLeapYear ? 1 : 0); break;
            case JUNE:      days = 151 + (isLeapYear ? 1 : 0); break;
            case JULY:      days = 181 + (isLeapYear ? 1 : 0); break;
            case AUGUST:    days = 212 + (isLeapYear ? 1 : 0); break;
            case SEPTEMBER: days = 243 + (isLeapYear ? 1 : 0); break;
            case OCTOBER:   days = 273 + (isLeapYear ? 1 : 0); break;
            case NOVEMBER:  days = 304 + (isLeapYear ? 1 : 0); break;
            case DECEMBER:
            default:
     ...
     * @throws RuntimeException if the value given is not associated with a month enum
